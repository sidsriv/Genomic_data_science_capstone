---
title: "Summary of the FastQC and Results"
...
### Summary
This report describes the brief descriptive data analysis of the quality of the mapped reads performed with TopHat for the three fetus and three adults sampels. Find [here](https://github.com/friveramariani/genomic-data-science/blob/master/Links-for-Summary-Alignments-and-FASTQC.md) the link for the six samples used in this genomic data science project. Both the alignment of the RNA-seq of the samples and the quality of the reads was performed [Galaxy](https://usegalaxy.org/). The FastQC files, both the html and txt files were downloaded to performed the descriptive analysis of quality of the reads. 
...
The Summary Alignment text files containing the information of the mapped reads can be found [here](https://github.com/friveramariani/genomic-data-science/blob/master/Links-for-Summary-Alignments-and-FASTQC.md), as well as the html and txt files for the FastQC by each sample.

Find all the R codes for this report [here](https://github.com/friveramariani/genomic-data-science/blob/master/FastQC-report.R).  
...
From the summary statistics above, we can see that the **mean of the percentage mapped reads** in the fetus group is **1% higher** than the adult group. Similarly, both the **mean for per sequence quality** and **quality score** is higher **in the fetus, but that is not the case for the percentage of GC content.